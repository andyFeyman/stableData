    ...
    <div className="drawer w-full flex flex-col justify-between min-h-screen bg-base-100">
            ...
            <ul className="menu menu-horizontal p-2">
              ...
              <div className="dropdown dropdown-bottom text-center dropdown-hover">
                ...
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-1 w-58 p-1 shadow-sm ">
                  <li className="hover:bg-gray-100"><a className="btn btn-ghost bg-gray-700" href="/btc4years">bitcoin 4 year cycle</a></li>
                  <li className="hover:bg-gray-100"><a className="btn btn-ghost bg-gray-700" href="/btcCompare"> Bitcoin vs. Stock Market</a></li>
                </ul>
              </div>
              ...
              <li>
                {currentUser ? (
                  ...
                  <div>
                    <a href={loginRedirectPath}>Login</a>
      ...
      <div className="drawer-side mt-20">
        ...
        <ul className="menu bg-base-200 w-60 p-2 min-h-1/2">
          ...
          <li className="hover:bg-white"><a href="/stablecoin" className="btn btn-ghost text-sm">StableCoin Data</a></li>
          <li>
            {currentUser ? (
              <div >
